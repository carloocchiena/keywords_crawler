...
(fatto diverse prove ma per ora anche se la pagina si crea, non riesco a generare il contenuto dell'iframe, vediamo domani! 

a questo punto se come leggo posso ritornare in una pagina separata ci piazzo subito un yield br così guadagno tempo!
...
eliminare import superflui (es. import nltk)
